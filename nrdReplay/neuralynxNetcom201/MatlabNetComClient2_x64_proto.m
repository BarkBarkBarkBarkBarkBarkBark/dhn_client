function [methodinfo,structs,enuminfo,ThunkLibName]=MatlabNetComClient2_x64_proto
%MATLABNETCOMCLIENT2_X64_PROTO Create structures to define interfaces found in 'MatlabNetComClient'.

%This function was generated by loadlibrary.m parser version 1.1.6.34 on Tue Dec 13 14:21:01 2011
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'MatlabNetComClient2_x64_thunk_pcwin64');
...
%  int GetCheetahObjectsAndTypes ( char ** cheetahObjects , char ** cheetahTypes , int * pNumBytesPerString , int * pNumStrings ); 
fcns.thunkname{fcnNum}='int32voidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='GetCheetahObjectsAndTypes'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'stringPtrPtr', 'stringPtrPtr', 'int32Ptr', 'int32Ptr'};fcnNum=fcnNum+1;
